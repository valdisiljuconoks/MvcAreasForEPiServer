...
namespace AreasResearch.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(SearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(Areas.Area1.Models.Area1Page) }, // Pages we can create under the start page...
        ExcludeOn = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(SearchPage), typeof(LandingPage), typeof(Areas.Area1.Models.Area1Page) })] // ...and underneath those we can't create additional start pages
